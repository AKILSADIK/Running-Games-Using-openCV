...
Original file is located at
    https://colab.research.google.com/drive/14Zzrq_xsXSku-M9fFUEGU2Bc0jt6br1S
...
!git clone https://github.com/Datastar07/Subway-suffer-Game-using-AI.git

# Commented out IPython magic to ensure Python compatibility.
# %cd /content/Subway-suffer-Game-using-AI
...
The function will visualize or return the resultant image and the horizontal position of the person's hand depending upon the passed arguments.
"""
